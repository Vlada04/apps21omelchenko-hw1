...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testClosestToZero() {
        double[] temperatureSeries = {3.0, -5.0, 2.0, 5.0, -1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double expResult = -1.0;
    ...
    public void testClosestToValue() {
        ...
        double[] temperatureSeries = {3.0, -5.0 , 5.0, -1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
    ...
    public void testClosestToValueWithEmptyArray() {
        ...
        // expect exception here
        seriesAnalysis.findTempClosestToValue(0.1);
    }
    ...
    public void testFindLessWithEmptyArray() {
        ...
        // expect exception here
        seriesAnalysis.findTempsLessThen(0.1);
    }
    ...
    public void testFindGreaterWithEmptyArray() {
        ...
        // expect exception here
        seriesAnalysis.findTempsGreaterThen(0.1);
    }
    ...
    public void testAddTempsNormal() {
        ...
        double actualResult = seriesAnalysis.addTemps(1.0, 2.0, 8.0);
        double expResult = 11;
